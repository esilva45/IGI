...
public class ASConnector extends Connector implements ConnectorInterface {
	...
	public String addAccount(Entry entry, int status, String cpf) {
		...
		try {
			if (type.equals("User")) {
				j1.put("CPF", cpf);
				j1.put("Matricula", util.isNullOrEmpty(entry.getString("ermatricula").trim()) ? JSONObject.NULL : entry.getString("ermatricula").trim());
				j1.put("Nome", util.isNullOrEmpty(entry.getString("ernome").trim()) ? JSONObject.NULL : entry.getString("ernome").trim());
				j1.put("Email", util.isNullOrEmpty(entry.getString("eremail").trim()) ? JSONObject.NULL : entry.getString("eremail").trim());
				j1.put("Situacao", status);
				j1.put("NivelCargo", util.isNullOrEmpty(entry.getString("ernivelCargo").trim()) ? JSONObject.NULL : entry.getString("ernivelCargo").trim());
				j1.put("Cargo", util.isNullOrEmpty(entry.getString("ercargo").trim()) ? JSONObject.NULL : entry.getString("ercargo").trim());
				j1.put("Cidade", util.isNullOrEmpty(entry.getString("ercidade").trim()) ? JSONObject.NULL : entry.getString("ercidade").trim());
				j1.put("Setor", util.isNullOrEmpty(entry.getString("ersetor").trim()) ? JSONObject.NULL : entry.getString("ersetor").trim());
				j1.put("CpfSuperiorImediato", util.isNullOrEmpty(entry.getString("ercpfSuperior").trim()) ? JSONObject.NULL : entry.getString("ercpfSuperior").trim());
				j1.put("EmpresaSeqLab", util.isNullOrEmpty(entry.getString("erempresaSeqLab").trim()) ? JSONObject.NULL : entry.getString("erempresaSeqLab").trim());
				j1.put("Empresa", util.isNullOrEmpty(entry.getString("erempresa").trim()) ? JSONObject.NULL : entry.getString("erempresa").trim());
				j1.put("CargoSeqLab", util.isNullOrEmpty(entry.getString("ercargoSeqLab").trim()) ? JSONObject.NULL : entry.getString("ercargoSeqLab").trim());
				j1.put("SetorSeqLab", util.isNullOrEmpty(entry.getString("ersetorSeqLab").trim()) ? JSONObject.NULL : entry.getString("ersetorSeqLab").trim());
				j1.put("CentroCustoSeqLab", util.isNullOrEmpty(entry.getString("ercentroCustoSeqLab").trim()) ? JSONObject.NULL : entry.getString("ercentroCustoSeqLab").trim());
				j1.put("CidadeSeqLab", util.isNullOrEmpty(entry.getString("ercidadeSeqLab").trim()) ? JSONObject.NULL : entry.getString("ercidadeSeqLab").trim());
				j1.put("EmpresaCNPJ", util.isNullOrEmpty(entry.getString("erempresaCNPJ").trim()) ? JSONObject.NULL : entry.getString("erempresaCNPJ").trim());
				...
				j1.put("LoginWindows", util.isNullOrEmpty(entry.getString("erloginWindows").trim()) ? JSONObject.NULL : entry.getString("erloginWindows").trim());
				j1.put("IndicativoUsuarioEstrangeiro", util.isNullOrEmpty(entry.getString("erindicativoUsuarioEstrangeiro").trim()) ? JSONObject.NULL : Integer.parseInt(entry.getString("erindicativoUsuarioEstrangeiro").trim()));
				j1.put("CodigoEmpresaContratante", util.isNullOrEmpty(entry.getString("ercodigoEmpresaContratante").trim()) ? JSONObject.NULL : Long.parseLong(entry.getString("ercodigoEmpresaContratante").trim()));
